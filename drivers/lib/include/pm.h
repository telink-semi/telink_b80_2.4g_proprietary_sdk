...
typedef unsigned int (*tick_32k_get_t)(void);
/**
 * @brief      This function servers to get call back for 32k tick.
 * @param[in]  tick_32k_get_t - the time of 32k tick get back.
 * @return     none
 */
