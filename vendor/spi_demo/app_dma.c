 ...
 *********************************************************************************************************************/
 spi_pin_config_t spi_pin_config = {
		.spi_clk_pin	   = GPIO_PC0,// GPIO_SPI_CK  =GPIO_PB1  (default),if you not use default,should disable it.
		.spi_csn_pin 	   = GPIO_PC4,// GPIO_SPI_CN  =GPIO_PB0  (default),if you not use default,should disable it.
...
//	gpio_set_input_en(LED1|LED2,0);	//disable input
    ...
    spi_set_io_mode(SPI_SINGLE_MODE);
