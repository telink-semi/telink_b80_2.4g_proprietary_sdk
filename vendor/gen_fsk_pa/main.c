...
#define    FUNC_TEST         FUNC_STX_TEST
...
int main(void)
{
    ...
    gpio_set_func(GPIO_PC1|GPIO_PC2|GPIO_PC3|GPIO_PC4, AS_GPIO);
    gpio_set_output_en(GPIO_PC1|GPIO_PC2|GPIO_PC3|GPIO_PC4, 1); //enable output
    gpio_write(GPIO_PC1|GPIO_PC2|GPIO_PC3|GPIO_PC4, 0); //
